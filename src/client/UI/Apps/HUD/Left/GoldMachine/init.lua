...
local FrameName = "Trade" .. "_" .. FrameRandomUUID

function Trade(_, hooks)
	...
	return Roact.createElement("Frame", {
		...
		Image = Roact.createElement("ImageButton", {
			...
			[Roact.Event.MouseButton1Click] = function()
				Store:dispatch(UIAction.setCurrentFrame("GoldMachineUI"))
			end,
...
Trade = RoactHooks.new(Roact)(Trade)
return Trade
