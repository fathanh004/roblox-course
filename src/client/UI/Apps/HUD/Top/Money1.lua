...
function Money1(_, hooks)
    ...
    Color=ColorSequence.new({ColorSequenceKeypoint.new(0,Color3.fromHex('ff821f')),ColorSequenceKeypoint.new(1,Color3.fromHex('faf886'))}),
}),
